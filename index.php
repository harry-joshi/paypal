...
<div class="clear"></div>
		...
		<div class="main-wrapper">
			...
			<div class="hero main-banner-wrapper">
							...
							<div class="col-sm-12 no-padding">
									<div class="calendar_wrapper">
										<div class="calendar-panel">
											<span class="ease-calendar"></span>
											<div class="datepicker" id="custom-dt">
												<div class="datepicker-header"></div>
											</div>
											<input type="text" name="" value="" class="selective-date x-invisible" />
										</div>
									</div>
								<div class="owl-carousel owl-theme banner-slider">
				                <div class="item">
				                    <img src="images/tour-banner/moto.jpg" alt="images not found">
				                    <div class="cover">
				                        <div class="container">
				                            <div class="header-content">
				                                ...
				                                <h4>We help entrepreneurs, start-ups and enterprises shape their ideas into products Start-ups and solutions Teimagine Digital Experience with</h4>
				                            </div>
				                        </div>
				                     </div>
				                </div>                    
				                <div class="item">
				                    <img src="images/tour-banner/moto-2.jpg" alt="images not found">
				                    <div class="cover">
				                        <div class="container">
				                            <div class="header-content">
				                ...
				                <div class="item">
				                    <img src="images/tour-banner/moto-3.jpg" alt="images not found">
				                    <div class="cover">
				                        <div class="container">
				                            <div class="header-content">
				                                <div class="line animated bounceInLeft"></div>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="india-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/india.jpg" alt="GlobeTrot" />
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="nepal-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/nepal.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Nepal</h5>
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="bhutan-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/bhutan.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Bhutan</h5>
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="vietnam-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/vietnam.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Vietnam</h5>
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="srilanka-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/srilanka.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Sri Lanka</h5>
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="thailand-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/thailand.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Thailand</h5>
										</div>
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-30">
								<div class="package-grid-item"> 
                                                                    <a href="tibet-destination.php">
										<div class="image">
                                                                                    <img src="images/motocycle-tour/destination/tibet.jpg" alt="GlobeTrot" />
										</div>
										<div class="content clearfix">
											<h5>Tibet</h5>
										</div>
			...
			<section class="bg-light deals-off">
			
				<div class="container">
					
					<div class="row">

						<div class="deals-sec1 width-h">
							
							<div class="wp-offer">
								
								<div class="offer-image" style="background-image:url('images/summer-deal.jpg');"></div>

							</div>

						</div>

						<div class="deals-sec1 width-h bg-gradient-o">
							
							<div class="wp-offer-content">
								
								<div class="wp-offer-inner">
									<span class="wp-deal-title">Enjoy Summer Deals</span>
									<h2 class="wp-deal-discount">Up to 40% Discount!</h2>
									<a href="">Learn More</a>
									<div class="wp-site-brand">
										<img src="http://localhost/motorcycletour/images/logo-white.png">
									</div>
									<span class="tc">*Terms &amp; Conditions</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="wp-article">
								...
								<div class="wp-article-media">
									
									<img src="images/articles/1.jpg">

								</div>
								<a href="" class="wp-article-permalink">
									<i class="fa fa-link" aria-hidden="true"></i>
									<span>Click Here</span>
								</a>
								<div class="wp-article-overlay"></div>
								<div class="wp-article-overlay-outer"></div>
								<div class="wp-article-content">
									<p class="wp-article-title">Change your place and get the fresh air</p>
									<span class="wp-article-date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> June 6, 2019</span>
									<span class="wp-article-writer"><i class="fa fa-user" aria-hidden="true"></i> Ajeet Dhiman</span>
