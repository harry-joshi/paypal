...
<div class="clear"></div>
		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="page-title detail-page-title" style="background-image:url('images/motocycle-tour/destination/destination-banner/Tibet.jpg');">
				...
				<div class="container">
					...
					<div class="flex-row">
						...
						<div class="flex-column flex-md-8 flex-sm-12">
							...
							<h1 class="hero-title">Tibet Tour</h1>
						</div>
					</div>
                  ...
                  <div class="wrapper" style="background-image: url('./images/motocycle-tour/nepal-destination/kathmandu.jpg');">
                    ...
                    <div class="data">
                      <div class="content">
                        ...
                        <a href="tibet-tour-detail.php" class="button">Read more</a>
                      </div>
                    </div>
                  </div>
                </div>
