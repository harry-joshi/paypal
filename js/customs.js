...
jQuery(function($) {
	...
	"use strict";
		...
		/**
		 * Add active on sort-by
		 */

		$(document).ready(function() {
		$('#sort-attr li:first').addClass("active");
		$("#sort-attr li ").click(function () {
		    $("#sort-attr li ").removeClass("active");
		...
		/**
		 * Add active on list-grid view
		 */

		$(document).ready(function() {
		$('.grid-sort').addClass("active");
		$('.grid-view-element').show();
		$('.list-view-element').hide();
		$('.pager-list').hide();
		$(".list-sort ").click(function () {
		    $(".list-sort").addClass("active");
		    $(".grid-sort").removeClass("active"); 
		    $('.grid-view-element').fadeOut(400);
		    $('.list-view-element').fadeIn(400); 
		    $('.pager-list').show();  
		});
		$(".grid-sort ").click(function () {
		    $(".grid-sort").addClass("active");
		    $(".list-sort").removeClass("active");
		    $('.list-view-element').fadeOut(400); 
		    $('.grid-view-element').fadeIn(400);    
		});
		});
...
$(document).ready(function(){
	$(".datepicker").datepicker({
		onSelect: function(dateText, inst) {
	      $(".selective-date").val(dateText);
	    },
		prevText: '<i class=" fa fa-fw fa-angle-left"></i>',
		nextText: '<i class=" fa fa-fw fa-angle-right"></i>'
	});
		$('.ui-datepicker-next, .ui-datepicker-prev').hover(function(e){
	    	$(this).attr('title', '');
		});
});
/**
* calendar slider
*/
$(".ease-calendar").click(function(event){
	event.stopPropagation();
	$(".calendar-panel").toggleClass('right-0');
});
$(document).mouseup(function (e) { 
    if ($(e.target).closest(".calendar-panel").length === 0) { 
        $(".calendar-panel").removeClass('right-0'); 
    } 
}); 
/**
* Owl Carousel
