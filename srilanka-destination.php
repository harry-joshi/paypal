...
<div class="clear"></div>
		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="page-title detail-page-title" style="background-image:url('images/motocycle-tour/destination/destination-banner/Sri-lanka.jpg');">
				...
				<div class="container">
					...
					<div class="flex-row">
						...
						<div class="flex-column flex-md-8 flex-sm-12">
							...
							<h1 class="hero-title">Srilanka Tour</h1>
						</div>
					</div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-6 w-xs-100">
                 <div class="customize-tour card">
                  <div class="wrapper" style="background-image: url('./images/motocycle-tour/srilanka/colombo.jpg');">
                    <div class="header">
                      <div class="date">
                    ...
                    <div class="data">
                      <div class="content">
                        <span class="tour-name">Colombo</span>
                        ...
                        <a href="colombo-tour-detail.php" class="button">Read more</a>
                      </div>
                    </div>
                  </div>
                </div>
