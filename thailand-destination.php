...
<div class="clear"></div>
		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="page-title detail-page-title" style="background-image:url('images/motocycle-tour/destination/destination-banner/Thailand.jpg');">
				...
				<div class="container">
					...
					<div class="flex-row">
						...
						<div class="flex-column flex-md-8 flex-sm-12">
							...
							<h1 class="hero-title">Thailand Tour</h1>
						</div>
					</div>
			...
			<div class="content-wrapper">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12 hr-line " role="main">
			...
			<h4>Tour</h4>
                  ...
                  <div class="row">
                      <div class="col-sm-4">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">Sikkim</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                          </div>
                          </div>
                          </div>
                      ...
                      <div class="col-sm-4">
                         <div id="destination-tour">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">Ladakh</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                      ...
                      <div class="col-sm-4">
                         <div id="destination-tour">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">Sachi-Spiti</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                  ...
                  <div class="row tour-inner-row">
                      <div class="col-sm-4">
                          <div id="destination-tour">
                          <div class="wrapper-moto">
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">Uttrakhand</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                      ...
                      <div class="col-sm-4">
                         <div id="destination-tour">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">North East</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                      ...
                      <div class="col-sm-4">
                         <div id="destination-tour">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">South India</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto">Read More</a>
                  ...
                  <div class="row tour-inner-row">
                      <div class="col-sm-4">
                          ...
                          <img src="images/motocycle-tour/destination.png"> 
                          <div class="overlay">
                              <h3 class="content-head">Rajasthan</h3>
                              <div class="content-moto">
                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                              </div>
                              <a class="btn btn-primary btn-moto" href="rajasthan-tour-detail.php">Read More</a>
                          </div>
                          </div>
                          </div>
  ...
  <section class="tour-section">
    <div class="container">
      <div class="col-sm-12">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-6 w-xs-100">
                 <div class="customize-tour card">
                  <div class="wrapper" style="background-image: url('./images/motocycle-tour/thailand-destination/bangkok.jpg');">
                    <div class="header">
                      <div class="date">
                    ...
                    <div class="data">
                      <div class="content">
                        <span class="tour-name">Bangkok</span>
                        <h1 class="title"><a href="#">Stranger Things: The sound of the Upside Down The sound of the Upside Down Netflix will eagerly anticipate </a></h1>
                        ...
                        <a href="bangkok-tour-detail.php" class="button">Read more</a>
                      </div>
                    </div>
                  </div>
                </div>
